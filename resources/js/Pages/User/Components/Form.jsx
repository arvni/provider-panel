...
const UserForm = ({ values, setValues, cancel, submit, errors, edit }) => {
    ...
    const handleChangeMetaCountry = (key) => (_, value) =>
        setValues((previousData) => ({
            ...previousData,
            meta: {
                ...previousData.meta,
    ...
    return (
        <Container>
            <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                    <TextField
                        error={Object.keys(errors).includes("mobile")}
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                    <SelectSearch
                        error={Object.keys(errors).includes("roles")}
                ...
                <Grid size={12}>
                    <TextField
                        ...
                        error={Object.prototype.hasOwnProperty.call(errors, "meta.contact.address")}
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                    <TextField
                        ...
                        error={Object.prototype.hasOwnProperty.call(errors, "meta.contact.city")}
                        onChange={handleChangeMeta("contact")}
                        label="City"
                    />
                </Grid>
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                    <TextField
                        ...
                        error={Object.prototype.hasOwnProperty.call(errors, "meta.billing.name")}
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                    <TextField
                        ...
                        error={Object.prototype.hasOwnProperty.call(errors, "meta.billing.email")}
                        onChange={handleChangeMeta("billing")}
                        label="Email"
                        required
                    />
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                    <TextField
                        ...
                        error={Object.prototype.hasOwnProperty.call(errors, "meta.billing.phone")}
                        onChange={handleChangeMeta("billing")}
                        label="Phone"
                        required
                    />
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                    <TextField
                        ...
                        helperText={errors["meta.contact.city"]}
                        error={Object.prototype.hasOwnProperty.call(errors, "meta.billing.city")}
                        onChange={handleChangeMeta("billing")}
                        label="City"
                    />
                </Grid>
                <Grid size={12}>
                    <TextField
                        ...
                        error={Object.prototype.hasOwnProperty.call(errors, "meta.billing.address")}
                        onChange={handleChangeMeta("billing")}
                        label="Address"
                    />
                </Grid>
            ...
            {!edit ? (
                <>
                    <Grid container spacing={2}>
                        ...
                        <Grid size={{ xs: 12, sm: 6 }}>
                            <TextField
                                error={Object.keys(errors).includes("password_confirmation")}
