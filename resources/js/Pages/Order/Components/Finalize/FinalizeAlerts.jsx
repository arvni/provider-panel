                        ...
                        <Box component="ul" sx={{ m: 0, pl: 2, mb: 0 }}>
                            <Box component="li" sx={{ mb: 0.5 }}>
                                <Typography variant="body2">
                                    <strong>Review all sections:</strong> Ensure all patient and
                                    sample information is correct
                                </Typography>
                            </Box>
                            <Box component="li" sx={{ mb: 0.5 }}>
                                <Typography variant="body2">
                                    <strong>Submission:</strong> Once submitted, certain details
                                    cannot be modified
                                </Typography>
                            </Box>
                            <Box component="li">
                                <Typography variant="body2">
                                    <strong>Confirmation:</strong> You&apos;ll receive a
            ...
            {showSuccess && (
                ...
                >
                    ...
                    >
                        ...
                        <Typography variant="body2">
                            Your order has been successfully submitted. We&apos;ll begin processing
                            it right away. You will be redirected to the orders list in a few
                            seconds.
                        </Typography>
                    </Alert>
                </motion.div>
