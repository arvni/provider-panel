    ...
    return <Grid container spacing={2} mt={2}>
        <Grid item xs={12} sm={8}>
            ...
            <Grid container spacing={1.5} mt={2}>
                <Grid item xs={6}>
                    <TextField fullWidth label={"ID No."} value={props.patient?.id_no ?? ""}
                               name={"id_no"} onChange={handleChange}/>
                </Grid>
                <Grid item xs={6}>
                ...
                <Grid item xs={6}>
                    <FormControl fullWidth>
                        <InputLabel id="consanguineousParents-label" required>Are Parents Consanguineous ?</InputLabel>
                        <Select required
                ...
                <Grid item xs={6}>
                    <FormControl fullWidth required>
                        <InputLabel error={!!props.errors["gender"]}
                                    id="gender-label"
                                    required>Gender</InputLabel>
                        <Select required
                                ...
                                onChange={handleChange}
                        >
                            {props.genders.map((gender, index) => <MenuItem key={index}
                                                                            value={gender}>{Gender.get(gender)}</MenuItem>)}
                        </Select>
                        <FormHelperText
        ...
        <Grid item xs={12} sm={4}>
            <Button variant="contained" onClick={props.handlePatientListOpen}>Choose From Patient list</Button>
        </Grid>
