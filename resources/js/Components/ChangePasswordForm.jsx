...
const ChangePasswordForm = ({ open, onClose, user = undefined }) => {
    const { data, reset, submit, processing, clearErrors, setError, errors, handleChange } =
        useSubmitForm(
            {
                current_password: "",
                password: "",
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        clearErrors();
        if (changePasswordValidator(data, setError, user)) submit({ onSuccess: () => onClose() });
    };
