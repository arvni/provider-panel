...
/**
 * Enhanced FormField component with improved styling and user feedback
 *
...
const FormField = ({
    ...
    const hasError = errors && errors[rest.name];
    const errorMessage = hasError ? errors[rest.name] : "";
