...
export const useNotifications = (options = {}) => {
    ...
    } = useSWR(`/notifications${unreadOnly ? "?unread_only=true" : ""}`, fetcher, {
        refreshInterval,
                ...
                ["", "?unread_only=true"].forEach((query) => {
                    mutate(
                        ...
                        (currentData) => {
                            ...
                            const deletedNotification = currentData.notifications.find(
                            ...
                            return {
                                ...currentData,
                                notifications: currentData.notifications.filter(
                                    (n) => n.id !== notificationId
                                ),
